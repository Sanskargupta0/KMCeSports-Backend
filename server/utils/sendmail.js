...
<html lang="en">
  ...
  >
    ...
    >
      ...
      `;
    } else if (tamplate == "login"){
      subject = "Registration Successful for KMCeSports";
      text = `
Welcome to KMCeSports!

Hey ${name},

Congratulations! Your registration with KMCeSports was successful. Now you can enjoy using our platform to the fullest.
...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta http-equiv="X-UA-Compatible" content="ie=edge" />
    <title>Welcome to KMCeSports!</title>
